...
var buildFullPath = __webpack_require__(353);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(344), __webpack_require__(361), __webpack_require__(364)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
        factory(require('axios'), require('vue'), require('./currency-map'));
    } else {
        var mod = {
            exports: {}
        };
        factory(global.axios, global.vue, global.currencyMap);
        global.app = mod.exports;
    }
})(this, function (_axios, _vue, _currencyMap) {
    'use strict';
    ...
    var currencyMap = _interopRequireWildcard(_currencyMap);
    ...
    new _vue2.default({
        ...
        mounted: function mounted() {
            ...
            _axios2.default.post('/currencies').then(function (response) {
        ...
        methods: {
            ...
            setTo: function setTo(e) {
                ...
                try {
                    for (var _iterator2 = this.currencies[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            calc: function calc() {
                ...
                if (this.value && this.from && this.to) {
                    _axios2.default.post('/calc', {
                        value: parseFloat(this.value.toString().replace(/\s+/, '')),
                        from: this.from.currency,
                        to: this.to.currency }).then(function (response) {
                        var data = response.data;
                        var value = data.value.toLocaleString();
                        var diff = {
                            from: '1 ' + currencyMap[_this2.from.currency].symbol_native,
                            to: data.diff.toLocaleString() + ' ' + currencyMap[_this2.to.currency].symbol_native
                        };

                        _this2.result = {
                            value: value + ' ' + currencyMap[_this2.to.currency].symbol_native,
                            diff: diff
                        };
                    });
                }
...
var mergeConfig = __webpack_require__(138);
...
var utils = __webpack_require__(14);
var transformData = __webpack_require__(349);
...
var isAbsoluteURL = __webpack_require__(354);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(95), __webpack_require__(48), __webpack_require__(362).setImmediate))
